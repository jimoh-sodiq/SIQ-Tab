...
export interface StokeDotEvent {
  type: "stroke_dot";
  x: number;
  y: number;
  strokeId: string;
...
export type DrawingEvent = StrokeStartEvent | StokeMoveEvent | StrokeEndEvent | StokeDotEvent | UndoRedoEvent | ClearPageEvent | ClearDesktopEvent | UpdateDesktopEvent;